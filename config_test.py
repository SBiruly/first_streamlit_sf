...
sf_url = st.text_input("Snowflake URL", value="https://fpb94648.us-east-1.snowflakecomputing.com", help="Enter the Snowflake URL")
sf_warehouse = st.text_input("Snowflake Warehouse", value="COMPUTE_WH", help="Enter the Snowflake Warehouse")
sf_database = st.text_input("Snowflake Database", value="SF_DEV", help="Enter the Snowflake Database")
sf_schema = st.text_input("Snowflake Schema", value="SF_MARKETING_DEV", help="Enter the Snowflake Schema")
sf_user = st.text_input("Snowflake User", value="OPTIMIZATION", help="Enter the Snowflake User")
sf_password = st.text_input("Snowflake Password", type="password", help="Enter the Snowflake password")
sf_role = st.text_input("Snowflake Role", value="ACCOUNTADMIN", help="Enter the Snowflake Role")
sf_region = st.text_input("Snowflake Region", value="AWS_US_EAST_1", help="Enter the Snowflake Region")
external_stage_name = st.text_input("External Stage Name", value="AWS_DM_EXT_STG", help="Enter the External Stage Name")
source_schema = st.text_input("Source Schema", value="SF_MARKETING_DEV", help="Enter the Source Schema")
target_schema = st.text_input("Target Schema", value="dm_tgt_schema", help="Enter the Target Schema")
snowflake_account = st.text_input("Snowflake Account", value="fpb94648.us-east-1", help="Enter the Snowflake Account")
